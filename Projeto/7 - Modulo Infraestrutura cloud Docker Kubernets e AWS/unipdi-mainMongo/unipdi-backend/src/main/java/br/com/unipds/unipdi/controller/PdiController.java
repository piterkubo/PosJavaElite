...
public class PdiController {
    ...
    public PdiController(PdiServiceMongo pdiService) {
    ...
    public pdiresponsedtoMongo adicionarMeta(@PathVariable String matricula, @PathVariable String pdiId, @RequestBody MetaRequestDtoMongo dto) {
